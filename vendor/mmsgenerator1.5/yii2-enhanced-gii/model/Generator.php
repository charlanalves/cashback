...
namespace mmsgenerator15\enhancedgii\model;
...
//            [['modelClass'], 'validateModelClass'],
            ...
            [['columnsArray','skippedColumns', 'skippedRelations',
...
//                $this->controllerClass = $modelClassName . 'Controller';
 ...
 /**
     ...
     * @return array the generated attribute labels (name => label)
     */
    public function generateLabelsQueryCustom($columns) {
        $labels = [];
       
        foreach ($this->columnsArray as $column) {
            $label = Inflector::camel2words($column);
