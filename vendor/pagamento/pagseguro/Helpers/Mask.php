...
namespace vendor\pagamento\pagseguro\Helpers;

/**
 * Class Mask
 * @package vendor\pagamento\pagseguro\Helpers
 */
class Mask
{
    ...
    {
        if (\vendor\pagamento\pagseguro\Enum\Mask::isValidName(
            \vendor\pagamento\pagseguro\Enum\Mask::getType($type)
        )) {
            return true;
        }
        return false;
