...
$authorization = new \vendor\pagamento\pagseguro\Domains\Requests\Authorization();
...
$authorization->addPermission(\vendor\pagamento\pagseguro\Enum\Authorization\Permissions::CREATE_CHECKOUTS);
$authorization->addPermission(\vendor\pagamento\pagseguro\Enum\Authorization\Permissions::SEARCH_TRANSACTIONS);
$authorization->addPermission(\vendor\pagamento\pagseguro\Enum\Authorization\Permissions::RECEIVE_TRANSACTION_NOTIFICATIONS);
$authorization->addPermission(\vendor\pagamento\pagseguro\Enum\Authorization\Permissions::MANAGE_PAYMENT_PRE_APPROVALS);
$authorization->addPermission(\vendor\pagamento\pagseguro\Enum\Authorization\Permissions::DIRECT_PAYMENT);
