...
$preApproval = new \vendor\pagamento\pagseguro\Domains\Requests\PreApproval();
...
$preApproval->setShipping()->setType(\vendor\pagamento\pagseguro\Enum\Shipping\Type::SEDEX);
