...
namespace vendor\pagamento\pagseguro\Configuration;

use vendor\pagamento\pagseguro\Domains\AccountCredentials;
use vendor\pagamento\pagseguro\Domains\ApplicationCredentials;
use vendor\pagamento\pagseguro\Domains\Charset;
use vendor\pagamento\pagseguro\Domains\Environment;
use vendor\pagamento\pagseguro\Domains\Log;
use vendor\pagamento\pagseguro\Resources\Responsibility;

/**
 * Class Configure
 * @package vendor\pagamento\pagseguro\Configuration
 */
class Configure
{
