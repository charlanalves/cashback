 ...
 */
class Application implements \vendor\pagamento\pagseguro\Resources\Responsibility\Notifications\Handler
{
    /**
     * @var
     */
    ...
    public function handler()
    {
        if (!is_null(Xhr::getInputCode()) and
            ...
            Xhr::getInputType() == \vendor\pagamento\pagseguro\Enum\Notification::APPLICATION_AUTHORIZATION) {
