...
use vendor\pagamento\pagseguro\Domains\PaymentMethod\Groups;
use vendor\pagamento\pagseguro\Domains\PaymentMethod\Names;
...
class Accepted
{
    ...
    public function __construct()
    {
        if (is_null($this->accepted)) {
            $this->accepted = new \vendor\pagamento\pagseguro\Domains\PaymentMethod\Accepted();
        }
    }

    /**
     * @param $group
     * @return \vendor\pagamento\pagseguro\Domains\PaymentMethod\Accepted
     */
