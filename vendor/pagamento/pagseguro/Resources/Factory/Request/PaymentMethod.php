...
class PaymentMethod
{
    ...
    public function instance(\vendor\pagamento\pagseguro\Domains\PaymentMethod $paymentMethod)
    {
    ...
    public function withArray($array)
    {
        ...
        $paymentMethod = new \vendor\pagamento\pagseguro\Domains\PaymentMethod();
