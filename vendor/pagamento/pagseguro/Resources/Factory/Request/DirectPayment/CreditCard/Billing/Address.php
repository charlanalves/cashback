...
namespace vendor\pagamento\pagseguro\Resources\Factory\Request\DirectPayment\CreditCard\Billing;
...
class Address
{
    ...
    /**
     * @var \vendor\pagamento\pagseguro\Domains\DirectPayment\CreditCard\Billing
     */
    private $billing;
    ...
    /**
     * @param \vendor\pagamento\pagseguro\Domains\Address $address
     * @return \vendor\pagamento\pagseguro\Domains\DirectPayment\CreditCard\Billing
     */
    public function instance(\vendor\pagamento\pagseguro\Domains\Address $address)
    {
    ...
    public function withArray($array)
    {
        ...
        $address = new \vendor\pagamento\pagseguro\Domains\Address();
