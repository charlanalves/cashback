...
namespace vendor\pagamento\pagseguro\Parsers\Authorization\Search\Date;

/**
 * Class Response
 * @package vendor\pagamento\pagseguro\Parsers\Transaction\Search\Date
 */
/**
 * Class Response
 * @package vendor\pagamento\pagseguro\Parsers\Authorization\Search\Date
 */
class Response
{
    /**
    ...
    {
        $response = new \vendor\pagamento\pagseguro\Parsers\Authorization\Search\Response();
