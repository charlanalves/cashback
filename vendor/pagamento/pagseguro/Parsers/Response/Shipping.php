...
use vendor\pagamento\pagseguro\Resources\Factory\Shipping\Address;
use vendor\pagamento\pagseguro\Resources\Factory\Shipping\Cost;
use vendor\pagamento\pagseguro\Resources\Factory\Shipping\Type;
...
trait Shipping
{
    ...
    {
        $shippingClass = new \vendor\pagamento\pagseguro\Domains\Shipping();
