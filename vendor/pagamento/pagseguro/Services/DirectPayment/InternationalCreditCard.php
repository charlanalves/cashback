...
use vendor\pagamento\pagseguro\Parsers\DirectPayment\InternationalCreditCard\Request;
...
class InternationalCreditCard
{
     ...
     * @param \vendor\pagamento\pagseguro\Domains\Requests\DirectPayment\OnlineDebit $payment
     * @return string
     * @throws \Exception
     */
    public static function checkout(
        Credentials $credentials,
        \vendor\pagamento\pagseguro\Domains\Requests\DirectPayment\InternationalCreditCard $payment
    ) {
