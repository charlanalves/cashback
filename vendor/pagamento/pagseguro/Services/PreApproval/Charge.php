...
use vendor\pagamento\pagseguro\Parsers\PreApproval\Charge\Request;
use vendor\pagamento\pagseguro\Resources\Responsibility;

class Charge
{

    public static function create(Credentials $credentials, \vendor\pagamento\pagseguro\Domains\Requests\PreApproval\Charge $charge)
    {
