...
<html lang="<?= Yii::$app->language ?>">
    ...
    <body>
        ...
        <script>
        	...
        	* SYSTEM.Layout.innerLayout.telaCimaEsq => Célula superior a esquerda.
        	* SYSTEM.Layout.innerLayout.telaDir => Célula a direita.
        	...
        	*/
        	...
        	function loadLayout(){
        		...
        		var innerLayout = outerLayout.cells("a").attachLayout("3J");
        		...
        		return{
                    ...
                    telaBaixoEsq : innerLayout.cells("c"),
