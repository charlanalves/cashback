...
<html lang="<?= Yii::$app->language ?>">
    ...
    <body>
        ...
        <script>
			...
			* SYSTEM.Layout.innerLayout.principalTelaVert1 => para a primeira celula vertical.
			* SYSTEM.Layout.innerLayout.principalTelaVert2 => para a segunda celula vertical.
			* SYSTEM.Layout.innerLayout.principalTelaVert3 => para a terceira celula vertical.
			* SYSTEM.Layout.innerLayout.principalTelaVert4 => para a quarta celula vertical.

			* SYSTEM.Layout.innerLayout3W => para o layout interno, as celulas telaCimaEsq, telaCimaCent, telaCimaDir.
        	* SYSTEM.Layout.innerLayout3W.telaCimaEsq => para a Célula a esquerda.
        	* SYSTEM.Layout.innerLayout3W.telaCimaCent => para a Célula central.
            * SYSTEM.Layout.innerLayout3W.telaCimaDir => para a Célula a direita.
            ...
            *Siga o exemplo para Manipulação de células
				#innerLayout
				SYSTEM.Layout.principalTelaVert1.hideHeader();
                SYSTEM.Layout.principalTelaVert2.hideHeader();
				SYSTEM.Layout.principalTelaVert3.hideHeader();
				SYSTEM.Layout.principalTelaVert4.hideHeader();

				#innerLayout3W
				SYSTEM.Layout.innerLayout3W.hideHeader();
                SYSTEM.Layout.innerLayout3W.hideHeader();
				SYSTEM.Layout.innerLayout3W.hideHeader();
				SYSTEM.Layout.innerLayout3W.hideHeader();
            ...
            *Siga o exemplo para definir títulos das células
				...
				SYSTEM.Layout.tituloCellCima("a","text");
        	...
        	*/
        	...
        	function loadLayout(){
        		...
        		var innerLayout = outerLayout.cells("a").attachLayout("4E");
				var innerLayout3W = innerLayout.cells("a").attachLayout("3W");

        		innerLayout.setEffect('resize', true);
        		innerLayout.setEffect('collapse', true);

				innerLayout3W.setEffect('resize', true);
        		innerLayout3W.setEffect('collapse', true);

        		return{
        			innerLayout : innerLayout,
        			outerLayout : outerLayout,
					innerLayout3W : innerLayout3W,

        			telaCimaEsq : innerLayout3W.cells("a"),
        			telaCimaCent : innerLayout3W.cells("b"),
					telaCimaDir : innerLayout3W.cells("c"),

					principalTelaVert1 : innerLayout.cells("a"),
					principalTelaVert2 : innerLayout.cells("b"),
					principalTelaVert3 : innerLayout.cells("c"),
                    principalTelaVert4 : innerLayout.cells("d"),

                    //Define largura e altura das células
                    larguraCell: function(cell, largura){
                        innerLayout3W.cells(cell).setWidth(largura);
                    },
					...
					tituloCellCima: function(cell, titulo){
                        innerLayout3W.cells(cell).setText(titulo);
                        innerLayout3W.setCollapsedText(cell, titulo);
                    },
        		}
        	}
