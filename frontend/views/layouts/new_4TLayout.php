...
<html lang="<?= Yii::$app->language ?>">
    ...
    <body>
        ...
        <script>
        	...
        	* SYSTEM.Layout.innerLayout.telaCima => Célula superior.
        	* SYSTEM.Layout.innerLayout.telaBaixoEsq => Célula inferior a esquerda.
            * SYSTEM.Layout.innerLayout.telaBaixoDir => Célula inferior a direita.
            ...
            *Siga o exemplo para Manipulação de células
                SYSTEM.Layout.telaBaixoEsq.hideHeader();
                SYSTEM.Layout.telaBaixoDir.hideHeader();
        	...
        	*/
        	...
        	function loadLayout(){
        		...
        		var innerLayout = outerLayout.cells("a").attachLayout("4T");
        		...
        		return{
        			...
        			telaBaixoEsq : innerLayout.cells("b"),
                    telaBaixoCen : innerLayout.cells("c"),
                    telaBaixoDir : innerLayout.cells("d"),
