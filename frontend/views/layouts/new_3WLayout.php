...
<html lang="<?= Yii::$app->language ?>">
    ...
    <body>
        ...
        <script>
        	...
        	* SYSTEM.Layout.innerLayout.telaEsq => para a Célula a esquerda.
        	* SYSTEM.Layout.innerLayout.telaCen => para a Célula central.
            ...
            *Siga o exemplo para Manipulação de células
                SYSTEM.Layout.telaEsq.hideHeader();
                SYSTEM.Layout.telaCen.hideHeader();
