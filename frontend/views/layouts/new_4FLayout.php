...
<html lang="<?= Yii::$app->language ?>">
    ...
    <body>
        ...
        <script>
        	...
        	* SYSTEM.Layout.innerLayout. telaCimaEsq => para a Célula superior esquerda.
        	* SYSTEM.Layout.innerLayout.telaCimaDir => para a Célula superior direita.
            * SYSTEM.Layout.innerLayout.telaMeio => para a Célula central.
            ...
            *Siga o exemplo para Manipulação de células
                SYSTEM.Layout.telaCimaEsq.hideHeader();
                SYSTEM.Layout.telaCimaDir.hideHeader();
                SYSTEM.Layout.telaMeio.hideHeader();
        	...
        	*/
        	...
        	function loadLayout(){
        		...
        		var innerLayout = outerLayout.cells("a").attachLayout("4F");
        		...
        		return{
        			...
        			telaCimaEsq : innerLayout.cells("a"),
        			telaCimaDir : innerLayout.cells("b"),
                    telaMeio : innerLayout.cells("c"),
