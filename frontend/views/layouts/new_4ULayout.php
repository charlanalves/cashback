...
<html lang="<?= Yii::$app->language ?>">
    ...
    <body>
        ...
        <script>
        	...
        	* SYSTEM.Layout.innerLayout.telaCimaEsq => para a Célula a esquerda.
        	* SYSTEM.Layout.innerLayout.telaCimaCent => para a Célula central.
            * SYSTEM.Layout.innerLayout.telaDir => para a Célula a direita.
            ...
            *Siga o exemplo para Manipulação de células
                ...
                SYSTEM.Layout.telaCimaCent.hideHeader();
                SYSTEM.Layout.telaDir.hideHeader();
        	...
        	*/
        	...
        	function loadLayout(){
        		...
        		return{
        			...
        			telaCimaCent : innerLayout.cells("b"),
