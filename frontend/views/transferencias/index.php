...
<script type="text/javascript" charset="utf-8">
	...
	formConf = {
			...
			gridReload: 'Main',
			urlReloadGrid: './index.php?c=<?= $this->seg()->urlEncode("admin/transferencias/global-read&gridName=Main")?>',
			urlLoadGridPrefix: './index.php?r=<?= "admin/transferencias/global-read&gridName="?>',
