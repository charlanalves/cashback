...
class CB16PEDIDO extends \common\models\GlobalModel
{
    ...
    {
        return [
             [['CB16_TRANS_CRIADAS', 'CB16_EMPRESA_ID', 'CB16_ID_COMPRADOR', 'CB16_USER_ID', 'CB16_ID_FORMA_PAG_EMPRESA', 'CB16_STATUS', 'CB16_CARTAO_NUM_PARCELA', 'CB16_STATUS_DELIVERY'], 'integer'],
