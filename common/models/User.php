...
class User extends BaseUser implements IdentityInterface
{
 	...
 	public function rules()
    {
        return [
            ...
            ['cpf_cnpj', 'unique', 'targetClass' => '\common\models\User', 'message' => 'Este CPF/CNPJ j� foi usado.'],
            ...
            ['email', 'unique', 'targetClass' => '\common\models\User', 'message' => 'Este Email j� foi usado.'],
            
           
            
            ['id_indicacao', 'integer'],
            ['id_indicacao', 'exist', 'targetClass' => '\common\models\User', 'targetAttribute' => 'id', 'message' => 'A indica��o n�o � valida.'],
        ];
    }
