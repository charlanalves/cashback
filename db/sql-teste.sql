...
SELECT PAG04_TRANSFERENCIAS.PAG04_ID AS TRANSACAO_ID,
PAG04_ID AS TRANSFERENCIA_ID,
'TRANSAÇÃO' AS TIPO,
CB04_EMPRESA.CB04_ID AS EMPRESA_ID,
CB04_EMPRESA.CB04_NOME AS EMPRESA_NM, 
PAG04_TRANSFERENCIAS.PAG04_DATA_CRIACAO AS DT1,
PAG04_TRANSFERENCIAS.PAG04_DT_DEP AS DT2,
CB16_PEDIDO.CB16_VALOR AS VLR1,
PAG04_TRANSFERENCIAS.PAG04_VLR AS VLR2, 	
CB16_PEDIDO.CB16_USER_ID AS CLIENTE
FROM PAG04_TRANSFERENCIAS
INNER JOIN CB16_PEDIDO ON(CB16_ID = PAG04_ID_PEDIDO)
INNER JOIN CB04_EMPRESA ON(CB04_EMPRESA.CB04_ID=CB16_EMPRESA_ID)
WHERE PAG04_TIPO = 1
ORDER BY DT1 DESC
