...
-- CREDITO 
SELECT 
PAG04_ID AS TRANSFERENCIA_ID,
PAG04_TIPO AS TIPO,
PAG04_ID_PEDIDO AS PEDIDO_ID,
PAG04_DATA_CRIACAO AS DT_CRIACAO,
PAG04_DT_PREV AS DT_PREVISAO,
PAG04_DT_DEP AS DT_DEPOSITO,
PAG04_VLR AS VALOR,
PAG04_ID_USER_CONTA_DESTINO AS USER
FROM PAG04_TRANSFERENCIAS
WHERE PAG04_TIPO <> 'V2B' -- DIFERENTE DE SAQUE - ENTRA NO SEGUNDO SELECT
...
PAG04_DT_PREV AS DT_PREVISAO,
PAG04_DT_DEP AS DT_DEPOSITO,
PAG04_VLR*(-1) AS VALOR,
PAG04_ID_USER_CONTA_ORIGEM AS USER
FROM PAG04_TRANSFERENCIAS

ORDER BY USER, DT_CRIACAO DESC, TRANSFERENCIA_ID DESC



1 - MASTER TO EMPRESA
2 - EMPRESA TO ADQUIRENTE
3-  EMPRESA  TO CLIENTE
4 - EMPRESA  TO ADMIN
5 - VIRTUAL TO BANCÁRIA
6 - BANCÁRIA TO VIRTUAL
